    ...
    return (
        ...
        <StyledSobre onClick={ esconderOpcoes}>
            ...
            <div >
                ...
                <iframe width="330" height="315" src="https://www.youtube.com/embed/bT8oEcWGvrw" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </StyledSobre>
